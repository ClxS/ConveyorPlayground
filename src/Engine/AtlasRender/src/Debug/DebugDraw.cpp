...
struct GeometryT
{
	...
	atlas::render::debug::GeometryHandle create(uint32_t _numVertices, const atlas::render::debug::DdVertex* _vertices, uint32_t _numIndices, const void* _indices, bool _index32)
	{
...
//				index[num*6+ii*6+5] = uint16_t(ii+num);
	...
	atlas::render::debug::GeometryHandle createGeometry(uint32_t _numVertices, const atlas::render::debug::DdVertex* _vertices, uint32_t _numIndices, const void* _indices, bool _index32)
	{
...
struct DebugDrawEncoderImpl
{
	...
	void draw(const bx::Triangle& _triangle)
	{
		...
		else
		{
			...
			draw(false, 3, reinterpret_cast<const atlas::render::debug::DdVertex*>(&_triangle.v0.x), 0, NULL);
	...
	void draw(bool _lineList, uint32_t _numVertices, const atlas::render::debug::DdVertex* _vertices, uint32_t _numIndices, const uint16_t* _indices)
	{
		flush();
	...
	void drawQuad(atlas::render::debug::SpriteHandle _handle, const bx::Vec3& _normal, const bx::Vec3& _center, float _size)
	{
		if (!isValid(_handle) )
		{
	...
	void drawAxis(float _x, float _y, float _z, float _len, atlas::render::debug::Axis::Enum _highlight, float _thickness)
	{
		push();
...
atlas::render::debug::SpriteHandle ddCreateSprite(uint16_t _width, uint16_t _height, const void* _data)
{
...
atlas::render::debug::GeometryHandle ddCreateGeometry(uint32_t _numVertices, const atlas::render::debug::DdVertex* _vertices, uint32_t _numIndices, const void* _indices, bool _index32)
{
	return s_dds.createGeometry(_numVertices, _vertices, _numIndices, _indices, _index32);
}

void ddDestroy(atlas::render::debug::GeometryHandle _handle)
{
	s_dds.destroy(_handle);
}

void atlas::render::debug::debug_draw::begin(uint16_t _viewId, bool _depthTestLess, bgfx::Encoder* _encoder)
{
...
void atlas::render::debug::debug_draw::setDepthTestLess(bool _depthTestLess)
{
	s_dde.setDepthTestLess(_depthTestLess);
}

void atlas::render::debug::debug_draw::setState(bool _depthTest, bool _depthWrite, bool _clockwise)
{
	s_dde.setState(_depthTest, _depthWrite, _clockwise);
}

void atlas::render::debug::debug_draw::setColor(uint32_t _abgr)
{
	s_dde.setColor(_abgr);
}

void atlas::render::debug::debug_draw::setLod(uint8_t _lod)
{
	s_dde.setLod(_lod);
}

void atlas::render::debug::debug_draw::setWireframe(bool _wireframe)
{
	s_dde.setWireframe(_wireframe);
}

void atlas::render::debug::debug_draw::setStipple(bool _stipple, float _scale, float _offset)
{
	s_dde.setStipple(_stipple, _scale, _offset);
}

void atlas::render::debug::debug_draw::setSpin(float _spin)
{
	s_dde.setSpin(_spin);
}

void atlas::render::debug::debug_draw::setTransform(const void* _mtx)
{
	s_dde.setTransform(_mtx);
}

void atlas::render::debug::debug_draw::setTranslate(float _x, float _y, float _z)
{
	s_dde.setTranslate(_x, _y, _z);
}

void atlas::render::debug::debug_draw::pushTransform(const void* _mtx)
{
...
void atlas::render::debug::debug_draw::moveTo(float _x, float _y, float _z)
{
	s_dde.moveTo(_x, _y, _z);
}

void atlas::render::debug::debug_draw::moveTo(const bx::Vec3& _pos)
{
	s_dde.moveTo(_pos);
}

void atlas::render::debug::debug_draw::lineTo(float _x, float _y, float _z)
{
	s_dde.lineTo(_x, _y, _z);
}

void atlas::render::debug::debug_draw::lineTo(const bx::Vec3& _pos)
{
	s_dde.lineTo(_pos);
}
...
void atlas::render::debug::debug_draw::draw(const bx::Aabb& _aabb)
{
	s_dde.draw(_aabb);
}

void atlas::render::debug::debug_draw::draw(const bx::Cylinder& _cylinder)
{
	s_dde.draw(_cylinder, false);
}

void atlas::render::debug::debug_draw::draw(const bx::Capsule& _capsule)
{
	s_dde.draw(*reinterpret_cast<const bx::Cylinder*>(&_capsule), true);
}

void atlas::render::debug::debug_draw::draw(const bx::Disk& _disk)
{
	s_dde.draw(_disk);
}

void atlas::render::debug::debug_draw::draw(const bx::Obb& _obb)
{
	s_dde.draw(_obb);
}

void atlas::render::debug::debug_draw::draw(const bx::Sphere& _sphere)
{
	s_dde.draw(_sphere);
}

void atlas::render::debug::debug_draw::draw(const bx::Triangle& _triangle)
{
	s_dde.draw(_triangle);
}

void atlas::render::debug::debug_draw::draw(const bx::Cone& _cone)
{
	s_dde.drawCone(_cone.pos, _cone.end, _cone.radius);
}

void atlas::render::debug::debug_draw::drawFrustum(const void* _viewProj)
{
	s_dde.drawFrustum(_viewProj);
}

void atlas::render::debug::debug_draw::drawCircle(const bx::Vec3& _normal, const bx::Vec3& _center, float _radius, float _weight)
{
	s_dde.drawCircle(_normal, _center, _radius, _weight);
}

void atlas::render::debug::debug_draw::drawQuad(const bx::Vec3& _normal, const bx::Vec3& _center, float _size)
{
	s_dde.drawQuad(_normal, _center, _size);
}

void atlas::render::debug::debug_draw::drawQuad(bgfx::TextureHandle _handle, const bx::Vec3& _normal, const bx::Vec3& _center, float _size)
{
	s_dde.drawQuad(_handle, _normal, _center, _size);
}

void atlas::render::debug::debug_draw::drawCone(const bx::Vec3& _from, const bx::Vec3& _to, float _radius)
{
	s_dde.drawCone(_from, _to, _radius);
}

void atlas::render::debug::debug_draw::drawAxis(float _x, float _y, float _z, float _len, float _thickness)
{
    s_dde.drawAxis(_x, _y, _z, _len, atlas::render::debug::Axis::Count, _thickness);
}

void atlas::render::debug::debug_draw::drawCylinder(const bx::Vec3& _from, const bx::Vec3& _to, float _radius)
{
	s_dde.drawCylinder(_from, _to, _radius, false);
}

void atlas::render::debug::debug_draw::drawCapsule(const bx::Vec3& _from, const bx::Vec3& _to, float _radius)
{
	s_dde.drawCylinder(_from, _to, _radius, true);
}

void atlas::render::debug::debug_draw::drawGrid(const bx::Vec3& _normal, const bx::Vec3& _center, uint32_t _size, float _step)
{
