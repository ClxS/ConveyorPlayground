                                            ...
                                            commands::CommandType>& commands)
{
    while (!commands.empty())
    {
       ...
       /* case cpp_conv::commands::CommandType::PlaceStairsDown:
        ...
        case commands::CommandType::SelectItem3: kContext.m_uiContext.m_selected = 2 % static_cast<int32_t>(EntityKind::MAX); break;
        case commands::CommandType::SelectItem4: kContext.m_uiContext.m_selected = 3 % static_cast<int32_t>(EntityKind::MAX); break;
        case commands::CommandType::SelectItem5: kContext.m_uiContext.m_selected = 4 % static_cast<int32_t>(EntityKind::MAX); break;
        case commands::CommandType::SelectItem6: kContext.m_uiContext.m_selected = 5 % static_cast<int32_t>(EntityKind::MAX); break;
        case commands::CommandType::SelectItem7: kContext.m_uiContext.m_selected = 6 % static_cast<int32_t>(EntityKind::MAX); break;
        ...
        case commands::CommandType::PlaceSelection:
            tryPlaceEntity(kContext, static_cast<EntityKind>(kContext.m_uiContext.m_selected), kContext.m_uiContext.m_rotation, kContext.m_uiContext.m_bModifier);
            break;
